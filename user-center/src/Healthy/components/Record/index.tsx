...
const { ossHost, xAccessToken } = utils.appConfig;
...
function Record (props: {
  ...
  const healthyDetail = (val: string) => {
    ...
    Taro.navigateTo({
      url: `/pages/webview/index?url=${utils.appConfig.SERVICE_URL}record/recordDetail&code=${val}`
    });
  };
  return (
      ...
      {props.code === 'WEIGHT_HEIGHT' && (
        ...
        >
          ...
          <View className='record-item-center'>
            ...
            <View className='record-item-center-sub-text mr-32'>
