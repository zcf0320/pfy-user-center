...
function DrugHistory (props: IProps) {
  ...
  return (
    <View>
      <View className='modal-history-new-drug '>
        <View className='history-top flex'>
          <Text>
            是否{props.showNumber === 6 ? '有过敏史' : '备孕/怀孕/哺乳期'}
          </Text>
